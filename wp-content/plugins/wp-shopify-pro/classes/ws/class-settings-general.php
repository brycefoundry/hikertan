...
class Settings_General extends \WPS\WS {
	...
	*/
	public function update_settings_general() {
		...
		if (isset($form_data['wps_settings_general_url_webhooks']) && $form_data['wps_settings_general_url_webhooks']) {
			$newGeneralSettings['url_webhooks'] = esc_url($form_data['wps_settings_general_url_webhooks']);
		}
		...
		if (isset($form_data['wps_settings_general_selective_sync_customers'])) {
			$newGeneralSettings['selective_sync_customers'] = (int) $form_data['wps_settings_general_selective_sync_customers'];
		}

		if (isset($form_data['wps_settings_general_selective_sync_orders'])) {
			$newGeneralSettings['selective_sync_orders'] = (int) $form_data['wps_settings_general_selective_sync_orders'];
		}
