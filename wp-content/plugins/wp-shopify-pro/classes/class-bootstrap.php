...
use WPS\Factories\API_Settings_Checkout_Factory;
use WPS\Factories\API_Settings_Cart_Factory;
use WPS\Factories\API_Settings_Collections_Factory;
use WPS\Factories\API_Settings_Layout_Factory;
use WPS\Factories\API_Settings_Products_Factory;
use WPS\Factories\API_Settings_Related_Products_Factory;

use WPS\Factories\Webhooks_Factory;
use WPS\Factories\WS_Customers_Factory;
use WPS\Factories\WS_Orders_Factory;
...
class Bootstrap {
	...
	*/
	...
	public static function plugin_build() {
		...
		$results['WS_Customers'] 														= WS_Customers_Factory::build();
		$results['WS_Orders'] 															= WS_Orders_Factory::build();
		$results['WS_Webhooks'] 														= WS_Webhooks_Factory::build();
		$results['Webhooks'] 																= Webhooks_Factory::build();
		...
		$results['API_Settings_Checkout_Factory'] 					= API_Settings_Checkout_Factory::build();
		$results['API_Settings_Cart_Factory'] 							= API_Settings_Cart_Factory::build();
		$results['API_Settings_Collections_Factory'] 				= API_Settings_Collections_Factory::build();
		$results['API_Settings_Layout_Factory'] 						= API_Settings_Layout_Factory::build();
		$results['API_Settings_Products_Factory'] 					= API_Settings_Products_Factory::build();
		$results['API_Settings_Related_Products_Factory'] 	= API_Settings_Related_Products_Factory::build();
	...
	public static function plugin_init() {
		...
		$builds['WS_Orders']->init();
		$builds['WS_Customers']->init();
		$builds['WS_Webhooks']->init();
		$builds['Webhooks']->init();
		...
		$builds['API_Settings_Checkout_Factory']->init();
		$builds['API_Settings_Cart_Factory']->init();
		$builds['API_Settings_Collections_Factory']->init();
		$builds['API_Settings_Layout_Factory']->init();
		$builds['API_Settings_Products_Factory']->init();
		$builds['API_Settings_Related_Products_Factory']->init();
