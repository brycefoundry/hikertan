...
<div class="tab-content <?php echo $active_tab === 'tab-tools' ? 'tab-content-active' : ''; ?>" data-tab-content="tab-tools">
  ...
  <div class="wps-admin-section">
    ...
    <h3><?php esc_html_e('Reconnect Webhooks', WPS_PLUGIN_TEXT_DOMAIN); ?></h3>
    <p><?php esc_html_e('This will attempt to reconnect all Shopify webhooks. Useful if you notice your data not auto syncing correctly.', WPS_PLUGIN_TEXT_DOMAIN); ?></p>
    ...
    <div class="wps-button-group button-group button-group-ajax <?php echo $connected ? 'wps-is-active' : 'wps-is-not-active'; ?>">
      ...
      submit_button(esc_html__('Reconnect Webhooks', WPS_PLUGIN_TEXT_DOMAIN), 'primary', 'submitSettings', false, $props); ?>
