...
function html5blank_styles()
{
    ...
    wp_register_style('html5blank', get_template_directory_uri() . '/assets/css/style.css', array(), '1.0', 'all');
...
function cptui_register_my_cpts() {
    ...
    /**
     * Post Type: Field Reports.
     */

    $labels = array(
        "name" => __( "Field Reports", "" ),
        "singular_name" => __( "Field Report", "" ),
    );

    $args = array(
        "label" => __( "Field Reports", "" ),
        "labels" => $labels,
        "description" => "",
        "public" => true,
        ...
        "map_meta_cap" => true,
        "hierarchical" => false,
        "rewrite" => array( "slug" => "field-reports", "with_front" => true ),
        "query_var" => true,
    ...
    register_post_type( "field_reports", $args );
    ...
    $args = array(
        ...
        "map_meta_cap" => true,
        "hierarchical" => false,
        "rewrite" => array( "slug" => "our-kits", "with_front" => true ),
        "query_var" => true,
        "supports" => array( "title", "editor", "thumbnail", "excerpt", "trackbacks", "custom-fields", "comments", "revisions", "author", "page-attributes", "post-formats" ),
        "taxonomies" => array( "category", "post_tag" ),
    );
